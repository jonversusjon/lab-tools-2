...
EXPECTED_ROUTES = [
    ...
    ("POST", "/api/v1/import/conjugate-chemistries/preview"),
    ("POST", "/api/v1/import/conjugate-chemistries/commit"),
    ("POST", "/api/v1/import/flow-panels"),
    ("POST", "/api/v1/import/flow-panels/preview"),
    ("POST", "/api/v1/import/flow-panels/commit"),
    ("POST", "/api/v1/import/if-panels"),
    ("POST", "/api/v1/import/if-panels/preview"),
    ("POST", "/api/v1/import/if-panels/commit"),
    ("POST", "/api/v1/import/instruments"),
    ("POST", "/api/v1/import/instruments/preview"),
    ("POST", "/api/v1/import/instruments/commit"),
    ("POST", "/api/v1/import/list-entries"),
    ("POST", "/api/v1/import/list-entries/preview"),
    ("POST", "/api/v1/import/list-entries/commit"),
    ("POST", "/api/v1/import/microscopes"),
    ("POST", "/api/v1/import/microscopes/preview"),
    ("POST", "/api/v1/import/microscopes/commit"),
    ("POST", "/api/v1/import/secondaries"),
    ("POST", "/api/v1/import/secondaries/preview"),
    ("POST", "/api/v1/import/secondaries/commit"),
]
