    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="w-[480px] rounded-lg bg-white shadow-xl">
        <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4">
          <h2 className="text-lg font-bold">Fetch from FPbase</h2>
        ...
        <div className="px-6 py-4">
            ...
            <>
              ...
              <div className="max-h-60 overflow-y-auto rounded border border-gray-200">
                {catalogQuery.isLoading && (
                  <p className="px-3 py-6 text-center text-sm text-gray-400">Loading catalog...</p>
                )}
                ...
                {catalogQuery.data && filtered.length === 0 && (
                  <p className="px-3 py-4 text-center text-sm text-gray-400">No matches</p>
                )}
                {filtered.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isImported && (
                        <span className="text-xs text-green-600" title="Already imported">
                          &#10003; imported
                        </span>
                      )}
                    </button>
          ...
          {modalState === 'fetching' && (
            <div className="py-8 text-center">
              <p className="mb-2 text-sm font-medium">Fetching fluorophores...</p>
